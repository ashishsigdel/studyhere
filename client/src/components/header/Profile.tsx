    ...
    <div className="relative" ref={dropDownRef}>
      {user ? (
        <div>
          ...
          {/* Dropdown Menu */}
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-40 bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600 p-1 z-[9999]">
              <button
